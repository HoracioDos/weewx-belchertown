...
sitio."
        ...
        snapshot_low                = Mínima
        snapshot_today_high_wind    = Viento Hoy
        snapshot_today_high_uv      = UV Hoy
        snapshot_today_rain         = Precip Hoy
        snapshot_today_rainrate     = Precip Hora
        snapshot_month_high_wind    = Viento Mes
        snapshot_month_high_uv      = UV Mes
        snapshot_month_rain         = Precip Hora
